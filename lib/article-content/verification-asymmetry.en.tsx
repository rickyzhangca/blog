...
const EN_CONTENT = {
	...
	body: (
		<>
			...
			<p>
				Picture this: you&apos;re in a design review, and someone asks,
				&quot;let&apos;s do another round.&quot; The designer smiles and has no
				choice. Everyone has opinions, but no proof. This scenario plays out
				thousands of times daily across design teams worldwide, revealing a
				fundamental problem in how we approach design work.
			</p>
			<p>
			...
			/>
			<p>
				Consider a login page - it&apos;s easy to craft (established patterns
				exist) and easy to verify (users either can or cannot log in). Now
				consider a brand identity - it&apos;s hard to craft (requiring deep
				creative work) and even harder to verify (many stakeholders involved,
				success only somewhat correlates to long-term market performance, which
				itself suffers from infinite colliding factors).
			</p>
			<Image
			...
			<p>
				...
				writing fancy code - it&apos;s also about verifying code quality.
				Continuous integration turns &quot;it works on my machine&quot; into
				&quot;it works everywhere.&quot; Unit tests transform &quot;I think this
				works&quot; into &quot;I can prove this works.&quot;
			</p>
			<Image
			...
			<ul>
				...
				<li>
					Fear of iteration: When you can&apos;t verify improvements, change
					becomes risky
				</li>
				<li>
			...
			<p>
				Design engineers aren&apos;t just designers who code or developers who
				care about pixels. Their core value is improving verification practices
				with privileged information (software engineering knowledge). It makes
				design easier and faster. Here are some examples:
			</p>
			<ul>
				<li>Real prototypes</li>
				<p>
					Instead of designers only asking stakeholders &quot;how does this new
					navigation feel to users?&quot;, design engineers work with designers
					to build it and get buy-ins. Teams can click through it. Employees can
					dogfood it.
				</p>
				...
				<p>
					&quot;Can we build this? How to build this?&quot; often comes too
					late. Design engineers surface technical constraints early, turning
					them into design opportunities rather than last-minute compromises.
				</p>
			</ul>
			<Image
			...
			<p>
				...
				nothing revolutionizes design the way many imagined, let alone
				&quot;replace designers.&quot;
			</p>
			<p>
				...
				equipped. AI doesn&apos;t spit out good UI and UX. Meanwhile, AI makes
				design engineers more powerful than ever by making code cheaper to
				produce, so they now better accelerate verification, making design
				easier and faster for their teams.
			</p>
			<blockquote>
			...
			/>
			<p>
				Some people may ask &quot;wait, how about v0/Lovable/Bolt&quot;? Well,
				they are a good place to start with, a quick peek into design
				engineering.
			</p>
			<p>
			...
			<p>
				...
				verifications that v0 couldn&apos;t get in yet. Craft wise, it is also a
				huge challenge to finetune animation easings and timings - beyond what
				v0 could handle.
			</p>
			<Image
			...
			/>
			<p>
				Design engineering reframes the eternal &quot;should designers
				code?&quot; debate. It&apos;s on a very surface level. The actual
				question is:
			</p>
			...
			<p>
				...
				research methods. Sometimes it&apos;s new metrics. Right now in 2025,
				more people are coming to the agreement that answer is code.
			</p>
...
registerArticleContent("verification-asymmetry", "en", EN_CONTENT);
